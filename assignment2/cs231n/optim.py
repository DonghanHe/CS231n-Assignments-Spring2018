...
def rmsprop(x, dx, config=None):
    ...
    dx_rms = -config['learning_rate']/np.sqrt(config['epsilon']+config['cache'])*dx
    next_x = x+dx_rms
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def adam(x, dx, config=None):
    ...
    s_hat = config['m']/(1-config['beta1']**config['t'])
    r_hat = config['v']/(1-config['beta2']**config['t'])
    dx_ad = -config['learning_rate']*s_hat/np.sqrt(r_hat+config['epsilon'])
    next_x = x+dx_ad
